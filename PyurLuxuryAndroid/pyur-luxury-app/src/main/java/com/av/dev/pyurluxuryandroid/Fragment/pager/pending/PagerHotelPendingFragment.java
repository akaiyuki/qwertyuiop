...
//        ApiResponseRequest hotelObject = PSingleton.getSelectedRequest();
//
//        name.setText(hotelObject.getLifestyleFirstname()+" "+hotelObject.getLifestyleLastname());
//        time.setText(PEngine.formatTimeStamp(hotelObject.getDateAdded()));
//
//    }
