...
public class SeaTransportSummaryFragment extends Fragment {
    ...
    private void changeFont(){
        ...
        txtType.setTypeface(Fonts.latoBold);
        departure.setTypeface(Fonts.latoRegular);
        txtdeparture.setTypeface(Fonts.latoBold);
        txtdepdate.setTypeface(Fonts.latoBold);
        txtreturn.setTypeface(Fonts.latoRegular);
        txtreturnloc.setTypeface(Fonts.latoBold);
        txtreturndate.setTypeface(Fonts.latoBold);
        deptime.setTypeface(Fonts.latoRegular);
        txtdeptime.setTypeface(Fonts.latoBold);
