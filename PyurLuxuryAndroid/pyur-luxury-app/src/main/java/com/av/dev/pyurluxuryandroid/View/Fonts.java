package com.av.dev.pyurluxuryandroid.View;
...
/**
 * Created by CodeSyaona on 04/09/2017.
 */

public class Fonts {

    public static Typeface latoRegular = Typeface.createFromAsset(BaseActivity.INSTANCE.getAssets(), "fonts/lato/LatoRegular.ttf");
